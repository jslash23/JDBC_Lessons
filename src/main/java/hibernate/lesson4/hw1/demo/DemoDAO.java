...
///
        ...
        //По-друге коли створюєш кімнату, поміщуй туди об'єкт готелю. Витягуй його через findById

        //А щоб помістити кімнати в готель, створи колекцію кімнат і додай туди їх через той же findById.
        //А потім просто помісти колекцію в сеттер
    }
}
